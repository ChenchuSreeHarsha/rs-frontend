...
const HandleVerifyPropertyaddressDetails = () => {
  ...
  useEffect(() => {
    const LogMobNo = loginMobileNumberCon || mobileno || MobileNumber || '';
        ...
        try {
          ...
          if (!res.data.pancard && !res.data.dob && !res.data.gender) {
            ...
            setData({
              ...
              mobno: mobileno || MobileNumber || loginMobileNumberCon || ''
            });
            setIsEditable(true);
            console.log('empty');
          } else {
            ...
            setData((prevData) => ({
              ...
              dob: res.data.dob || '',
              mobno: res.data.mobno || mobileno || MobileNumber || loginMobileNumberCon || '',
  ...
  }, [mobileno, MobileNumber, loginMobileNumberCon, formData]);
        ...
        <div>
          ...
          <div className='mt-1'>
            ...
            <TextField
              ...
              id="outlined-disabled-input"
              label="Mobile No"
              value={formData?.mobileno || signUpDetails1?.mobileno || mobileno || MobileNumber || loginMobileNumberCon}
              disabled
              InputProps={{
                className: 'fw-bold'
              }}
        ...
        <div>
          ...
          <div className='mt-1'>
            ...
            <TextField
              ...
              id="outlined-disabled-input"
              label="Mobile No"
              value={formData?.mobileno || mobileno || MobileNumber || loginMobileNumberCon || ''}
              disabled
              InputProps={{
                className: 'fw-bold'
              }}
